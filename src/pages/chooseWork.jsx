    ...
    <Box className="flex-auto bg-no-repeat bg-cover bg-center flex flex-col justify-center items-center text-white px-72px overflow-hidden" style={{ backgroundImage: 'url(./banner.png)' }}>
      <Box component='div' className='w-full h-full overflow-auto bg-[#DAE6E5] relative px-32px pb-24px'>
        <header className='sticky w-full top-0 left-0 py-24px flex items-center justify-center bg-[#DAE6E5] z-10'>
          <Button variant='text' color='secondary' sx={{ position: 'absolute', left: '0' }} size='large'>
            <ArrowBackIosNew />
            <span className='text-xl' onClick={() => history.back()}>返回</span>
          </Button>
          <span className='text-3xl text-[#000c25] font-medium text-center'>选择工作中心</span>
        </header>
        <Grid container spacing={4}>
          {
            list.map((l, index) => <Grid key={index} item xs={4}>
              <Paper elevation={0} sx={{ padding: '18px 32px 34px', display: 'flex', flexDirection: 'column' }}>
                <Box>
                  <IconButton size='large'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"><path fill="#058373" fillRule="nonzero" d="M12 .5a4 4 0 0 1 3.995 3.8l.001.03a10.002 10.002 0 0 1 5.896 10.646l-.01-.006a4 4 0 1 1-4.237 6.764l.015.01-.096.066A9.953 9.953 0 0 1 12 23.5c-2.1 0-4.05-.648-5.66-1.755l.097-.073a4 4 0 1 1-4.302-6.711l-.027.014A10.002 10.002 0 0 1 8.003 4.33l-.002.084L8 4.5a4 4 0 0 1 4-4M8.417 6.28l.026.052a8 8 0 0 0-4.38 8.17L4.03 14.5H4a4 4 0 0 1 3.628 5.686l-.005.011A7.961 7.961 0 0 0 12 21.5c1.616 0 3.12-.479 4.377-1.303l-.005-.01a4 4 0 0 1 3.429-5.681l.199-.006-.062.002a8 8 0 0 0-4.382-8.17l-.011.023a4 4 0 0 1-7.128-.075M20 16.5a2 2 0 1 0 0 4 2 2 0 0 0 0-4m-16 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4m8-14a2 2 0 1 0 0 4 2 2 0 0 0 0-4" /></svg></IconButton>
                  <Box sx={{ margin: '16px 0 6px' }} className='text-[#000C25] text-2xl font-medium'>XXXX工作中心</Box>

      ...
      <Box className='w-80px bg-[#044244] flex flex-col justify-between items-center'>
        <Button variant="" className="w-80px h-96px">
          <Box className='flex flex-col justify-center items-center text-white text-lg font-medium'>
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"><g fill="#FFF" fill-rule="evenodd"><path fill="none" d="M0 0h24v24H0z"/><path fill-rule="nonzero" d="M22.88 12.172a2 2 0 0 1 .12.683V21a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2v-8.145a2 2 0 0 1 2.683-1.88L12 14l8.317-3.024a2 2 0 0 1 2.563 1.196m-1.88.683-9 3.273-9-3.273V21h18v-8.145M18 1a2 2 0 0 1 2 2v8.09l-2 .727V3H6v8.817l-2-.727V3a2 2 0 0 1 2-2zm-2.5 8v2h-7V9zm0-4v2h-7V5z"/></g></svg>
            <span className="mt-4px">任务</span>
          </Box>
        </Button>
        <Button className="w-80px h-96px">
          <Box className='flex flex-col justify-center items-center text-white text-lg font-medium'>

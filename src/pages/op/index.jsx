  ...
  return <Box component='main' className='h-full flex flex-col'>
    ...
    <Box className="flex-auto overflow-hidden flex">
      <Box className='w-80px bg-[#044244] flex flex-col justify-between items-center'>
        <Button onClick={() => setTabIndex(0)} variant={tabIndex === 0?'contained':''} className="w-80px h-96px">
        ...
        <Button onClick={() => setTabIndex(1)} variant={tabIndex === 1?'contained':''} className="w-80px h-96px">
          <Box className='flex flex-col justify-center items-center text-white text-lg font-medium'>
        ...
        <Button onClick={() => setTabIndex(2)} variant={tabIndex === 2?'contained':''} className="w-80px h-96px">
          <Box className='flex flex-col justify-center items-center text-white text-lg font-medium'>
        ...
        <Button onClick={() => setTabIndex(3)} variant={tabIndex === 3?'contained':''} className="w-80px h-96px">
          <Box className='flex flex-col justify-center items-center text-white text-lg font-medium'>
        ...
        <Button onClick={() => setTabIndex(4)} variant={tabIndex === 4?'contained':''} className="w-80px h-96px">
          <Box className='flex flex-col justify-center items-center text-white text-lg font-medium'>
      ...
      <Box className='flex-auto bg-[#DAE6E5] p-16px overflow-auto relative'>
        <TaskPage visibility={tabIndex===0?'flex':'none'} />

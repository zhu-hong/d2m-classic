  ...
  return <Box className='w-full h-full flex flex-col'>
    {
      ...
      <>
        ...
        <Box className='bg-white text-right py-13px'>
          <>
            <ColorButton onClick={() => adjustDialogRef.current.open()} ccolor='#006A9F' style={{width:'187px',height:'72px',borderRadius:'0'}}>
          ...
          <ColorButton ccolor='#058373' style={{width:'187px',height:'72px',borderRadius:'0'}}>

          ...
          <Box className='flex-auto overflow-auto bg-white p-16px flex flex-col relative'>
            ...
            {/* <Box className='flex-auto mt-8px' sx={{display:tabType===1?'flex':'none'}}>
              <Box className='w-512px overflow-auto text-[#000C25] border border-t border-l border-[#CECECE]'>
                ...
                <Box className='w-full bg-[#FFFFFF] children:py-10px flex children:border-b children:border-r children:border-[#CECECE] children:pl-10px'>
                  <Box sx={{width:'15%'}}>编号</Box>
                  <Box sx={{width:'25%'}}>名称</Box>
                  <Box sx={{width:'20%'}}>累计上料</Box>
                  <Box sx={{width:'20%'}}>已消耗量</Box>
                ...
                <Box className='w-full bg-[#F2F9F8] children:py-10px flex children:border-b children:border-r children:border-[#CECECE] children:pl-10px'>
                  <Box sx={{width:'15%'}}>编号</Box>
                  <Box sx={{width:'25%'}}>名称</Box>
                  <Box sx={{width:'20%'}}>累计上料</Box>
                  <Box sx={{width:'20%'}}>已消耗量</Box>

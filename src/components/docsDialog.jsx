...
export const Docs = forwardRef((_, ref) => {
  ...
  return <Dialog open={open} maxWidth='840px' onClose={() => setOpen(false)} scroll='paper'>
    ...
    </DialogTitle>
    {
      ...
      <DialogContent className='w-840px'>
        <Box className='px-24px h-90px border mt-16px w-full border-[#CECECE] bg-[#F6F6F6] flex items-center justify-between'>

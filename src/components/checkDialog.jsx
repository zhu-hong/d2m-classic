  ...
  return <Dialog open={open} maxWidth='1064px' onClose={onClose} scroll='paper'>
    ...
    <DialogContent className="w-1064px mt-24px">
      ...
      <Box className='border border-[#CECECE] mt-17px'>
        ...
        {
          checkItem.map((c, i) => {
            return <Box key={c.OrdercaGuid} className={['w-full h-72px leading-72px flex children:border-b not-last:children:border-r children:border-[#CECECE] children:pl-10px', ['bg-[#FFFFFF]','bg-[#F2F9F8]'][i%2]].join(' ')}>
